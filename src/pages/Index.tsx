          ...
          <div className="ayush-container">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-600 mb-8">
                Streamline your registration process for startups in Ayurveda, Yoga, Unani, Siddha, and Homoeopathy sectors.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                {user ? (
                  ...
                  <>
                    ...
                    <Link to="/login">
                      <Button variant="outline" className="w-full sm:w-auto border-ayush-green text-ayush-green hover:bg-ayush-light-green px-8 py-6 text-lg">
                        Login
                      </Button>
                    </Link>
                  </>
        ...
        <section className="py-16 bg-white">
          <div className="ayush-container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
              {[
                { name: 'Ayurveda', color: 'bg-ayush-green', description: 'Traditional Indian system of medicine' },
                { name: 'Yoga', color: 'bg-ayush-blue', description: 'Ancient practice focusing on mind-body harmony' },
                { name: 'Unani', color: 'bg-ayush-saffron', description: 'Greco-Arabic medical tradition' },
                { name: 'Siddha', color: 'bg-ayush-orange', description: 'Ancient Tamil system of healing' },
                { name: 'Homeopathy', color: 'bg-ayush-red', description: 'Alternative medicine based on "like cures like"' }
              ].map((sector, index) => (
          ...
          <div className="ayush-container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-lg shadow-md">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-3">Simplified Application</h3>
                <p className="text-gray-600">
                  Step-by-step application process with intuitive forms and real-time validation.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-md">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-3">Status Tracking</h3>
                <p className="text-gray-600">
                  Real-time tracking of your application with timely notifications on progress.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-md">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-3">Secure Document Management</h3>
                <p className="text-gray-600">
              ...
              <div className="bg-white p-8 rounded-lg shadow-md">
                ...
                <p className="text-gray-600">
                  Different access controls for startups, officials, and regulatory authorities.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-md">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-3">AYUSH Resources</h3>
                <p className="text-gray-600">
                  Comprehensive library of resources and guidelines for AYUSH startups.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-md">
                ...
                <p className="text-gray-600">
                  Enterprise-grade security for all your sensitive data and documents.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="ayush-container">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl mb-8">
                Join the growing community of AYUSH startups and streamline your registration process today.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                {user ? (
                  <Link to="/dashboard">
